---
title: "Get ERC-1155 Token Transfers by Address"
sidebarTitle: "ERC-1155 Transfers"
description: "GET /v2/api?module=account&action=token1155tx — Retrieves ERC-1155 multi-token transfer history for an address, with optional contract and block range filtering."
---
